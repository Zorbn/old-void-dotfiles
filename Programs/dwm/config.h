...
static const char *fonts[]          = { "HackNerdFont:style=Regular:size=12" };
static const char dmenufont[]       = "HackNerdFont:style=Regular:size=12";
...
static const char col_cyan[]        = "#C6A679";
